                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="modal-body">
                                <form method="post" action="{{ route('add.Department') }}">
                                    ...
                                    <div class="card-body">
                                        <div class="m-t-20">
                                        <input type="text" class="form-control" placeholder="Department" maxlength="25" name="departments" required />
                                        @error('department')
                                        ...
                                        <button type="submit" class="btn btn-block btn-secondary">Add Department</button>
                        ...
                        <div id="basic-datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="row">
                                ...
                                <thead>
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="basic-datatable" rowspan="1" colspan="1" style="width: 437.8px;" aria-label="Options: activate to sort column ascending">DEPARTMENT</th>
                                    <th class="sorting" tabindex="0" aria-controls="basic-datatable" rowspan="1" colspan="1" style="width: 437.8px;" aria-label="Options: activate to sort column ascending">OPTIONS</th>                   
                                </tr>
                                </thead>
                                <tbody>
                                    @foreach($department as $departmentVieiw)	
                                    <tr role="row" class="odd">
                                        <td tabindex="0" class="sorting_1">{{ $departmentVieiw->department_id }}</td>
                                        <td tabindex="0" class="sorting_1">{{ $departmentVieiw->departments }}</td>
                                        <td>
