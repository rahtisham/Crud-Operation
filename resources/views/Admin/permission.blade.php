                ...
                <div class="row ">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="page-title">
                                <i class="mdi mdi-calendar-today title_icon"></i> PERMISSION &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <button  type="button" data-toggle="modal" data-target="#exampleModalCenter" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="rightModal('https://demo.creativeitem.com/ekattor/modal/popup/routine/create', 'Create routine')"> <i class="mdi mdi-plus"></i> Add Permission </button>
                                </h4>
                            </div> <!-- end card body-->
                        </div> <!-- end card -->
                    </div><!-- end col-->
                    ...
                    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLongTitle"><i class="mdi mdi-calendar-today title_icon"> <b>CREATE ROLES</b> +</i></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form method="post" action="{{ route('create-permission') }}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="m-t-20">
                                        <input type="text" class="form-control" placeholder="permission" maxlength="25" name="permission" />
                                        @error('permission')
                                        ...
                                        <button type="submit" id="check-minutes" class="btn btn-block btn-secondary">Permission ++</button>
                                        </span>   
                                    </div> 
                                </form>   
                            </div>
                                ...
                                <div id="basic-datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                    <div class="row">
                                        ...
                                        <thead>
                                            ...
                                            <th class="sorting" rowspan="1">Roles</th>
                                        ...
                                        <tbody>	
                                           @foreach($permissions as $permission)
                                                <tr role="row" class="odd" style="text-align: center;">
                                                    <td tabindex="0" class="sorting_1">{{ $permission->name }}</td>
                                                    <td tabindex="0" class="sorting_1">{{ $permission->guard_name }}</td>
