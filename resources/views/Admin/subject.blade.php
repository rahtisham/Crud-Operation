               ...
               <div class="row ">
                    <div class="col-xl-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="page-title">
                                <i class="mdi mdi-calendar-today title_icon"></i> SUBJECT &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <button  type="button" data-toggle="modal" data-target="#exampleModalCenter" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="rightModal('https://demo.creativeitem.com/ekattor/modal/popup/routine/create', 'Create routine')"> <i class="mdi mdi-plus"></i> Add Subject </button>
                                </h4>
                            </div> <!-- end card body-->
                        </div> <!-- end card -->
                    </div><!-- end col-->
                            ...
                            <div class="modal-body">
                                ...
                                <form method="post" action="{{ route('Add.Subject') }}">
                                    ...
                                    <span class="input-group-append">
                                        <button type="submit" id="check-minutes" class="btn btn-block btn-secondary">SUBJECT ++</button>
                                    </span>  
                                        ...
                                        <tbody>	
                                            @foreach($ViewSubjectListing as $subjects)
                                                <tr role="row" class="odd" style="text-align: center;">
                                                    <td tabindex="0" class="sorting_1">{{ $subjects->subject_id }}</td>
                                                    <td tabindex="0" class="sorting_1">{{ $subjects->ClassID }}</td>
                                                    <td tabindex="0" class="sorting_1">{{ $subjects->subject }}</td>
