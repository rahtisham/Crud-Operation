                ...
                <div class="row ">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="page-title">
                                <i class="mdi mdi-calendar-today title_icon"></i> ROLES &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <button  type="button" data-toggle="modal" data-target="#exampleModalCenter" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="rightModal('https://demo.creativeitem.com/ekattor/modal/popup/routine/create', 'Create routine')"> <i class="mdi mdi-plus"></i> Add role </button>
                                </h4>
                            </div> <!-- end card body-->
                        </div> <!-- end card -->
                    </div><!-- end col-->
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="modal-body">
                                <form method="post" action="{{ route('create-roles') }}">
                                    ...
                                    <div class="card-body">
                                        <div class="m-t-20">
                                        <input type="text" class="form-control" placeholder="Role" maxlength="25" name="role" />
                                        @error('role')
                                        ...
                                        <button type="submit" id="check-minutes" class="btn btn-block btn-secondary">Roles ++</button>
                                        </span>   
                                    </div> 
                                </form>   
                            </div>
                                        ...
                                        <tbody>	
                                           @foreach($roles as $role)
                                                <tr role="row" class="odd" style="text-align: center;">
                                                    ...
                                                    <td tabindex="0" class="sorting_1">{{ $role->guard_name }}</td>
